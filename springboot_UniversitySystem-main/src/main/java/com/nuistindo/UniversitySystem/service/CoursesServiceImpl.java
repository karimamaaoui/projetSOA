...
public class CoursesServiceImpl implements CoursesService{
    ...
    public CoursesModel addCourse(String id, String course_name, String faculty, TeachersModel teachersModel) {
        if (id == null || course_name == null) {
            ...
            course.setTeacher_id(teachersModel);
            return coursesRepository.save(course);
        }
    }

    public CoursesModel updateCourse(String id, String course_name, String faculty, TeachersModel teacher_id) {
        if (id == null || course_name == null) {
            return null;
        } else {
